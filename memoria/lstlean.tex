...
{~}{{\fontfamily{ptm}\selectfont \textasciitilde}}1% is usually part of a keyword, like #check
...
tabsize=2, % Size of tabulations
extendedchars=false, % Enables ASCII chars 128 to 255
...
keywordstyle=[1]{\ttfamily\color{keywordcolor}}, % Style for declaration keywords
keywordstyle=[2]{\ttfamily\color{sortcolor}}, % Style for sorts
keywordstyle=[3]{\ttfamily\color{errorcolor}}, % Style for errors
keywordstyle=[4]{\ttfamily\color{tacticcolor}}, % Style for tactics keywords
keywordstyle=[5]{\ttfamily\color{attributecolor}}, % Style for attributes
stringstyle={\ttfamily\color{stringcolor}}, % Style for strings
commentstyle={\ttfamily\itshape\color{commentcolor}}, % Style for comments
