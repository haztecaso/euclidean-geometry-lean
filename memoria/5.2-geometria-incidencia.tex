...
En las demostraciones es útil tener una forma de, dados dos puntos distintos,
...
\end{lstlisting}
	...
	\item \lstinline{exact unique_of_exists_unique (ig.I1 hAB) ⟨hA.left,hB.left⟩ ⟨hA.right,hB.right⟩,}\\[.5em]
	      ...
	      estándar de Lean, sirve para extraer la parte de unicidad del cuantificador
	      ...
	      particularizado con la hipótesis \lstinline{hAB : A ≠ B}. Es decir
	      ...
	      tener que especificar explícitamente que queremos construir una
