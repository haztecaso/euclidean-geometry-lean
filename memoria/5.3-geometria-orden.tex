...
escribiremos $A * B * C$ para indicar que están relacionados.
...
definida. Dicha función se llamará como la estructura más la notación
...
\lstleanfull{order_geometry/basic.lean}{73}{76}
...
En este caso el orden de los puntos que determinan un rayo sí que es importante.
...
Podemos definir de esta manera otro constructor para ángulos:
...
\lstleanfull{order_geometry/propositions.lean}{59}{60}
