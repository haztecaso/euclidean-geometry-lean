...
\todo{especificar siempre qué teoría a que teoría de tipos me refiero}
...
\todo{Mencionar que la igualdad es un tema delicado.}
...
\todo{Mencionar que el sistema de tipos CIC añade más construcciones, como los
	tipos inductivos o los tipos dependientes.}
...
\todo{Explicar comando \lstinline{variable}}
...
\todo{Explicar cómo se expresan las proposiciones. or, and, neg, forall, exists,
	neq, etc}

\subsection{Demostraciones}

\todo{Explicar qué es una demostración en teoría de tipos (term mode). Explicar
	qué son las tácticas y cómo funciona el modo táctico.}

\todo{Incluir anexo hablando sobre el entorno de desarrollo y el modo táctico,
	con captura de pantalla.}


\subsection{Mathlib}

\todo{Contar alguna cosa básica. Explicar cómo utilizar la web para encontrar cosas.}
