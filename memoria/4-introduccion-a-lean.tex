...
\textit{$a$ tiene tipo $A$} escribimos $a:A$. Esta misma notación es la
...
definición\guillemotright, y escribimos $a\equiv b : A$ \footnote{En
	...
	símbolo \lstinline{=}. También existen las igualdades \textit{definicionales} y
...
Lean implementa una versión de la teoría de tipos dependiente conocida como
...
\begin{itemize}[topsep=0pt]
	\item \textbf{Abstracción}. Es el mecanismo de definición de funciones mediante
	      ...
	      se puede convertir la variable libre \lstinline{x} en una variable
...
Si queremos que la identidad definida sea general y se le puedan aplicar términos
...
Así los parámetros indicados entre llaves, llamados \textit{parámetros
	implícitos}, serán deducidos automáticamente.
...
La correspondencia de Curry-Howard afirma que estas $\lambda$-funciones
